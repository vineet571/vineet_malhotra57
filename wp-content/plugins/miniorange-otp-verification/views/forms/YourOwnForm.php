...
echo'		<div class="mo_otp_form" id="'.get_mo_class($handler).'">
		        ...
		        <input  type="checkbox" '.$disabled.' 
                        ...
                        value="1" '.$custom_form_enabled.' /><strong>'. $form_name . '</strong>';

echo'			<div class="mo_registration_help_desc" '.$custom_form_hidden.' id="custom_form_contact_options">
                    <p><input type="radio" '.$disabled.' id="custom_form_contact_email" class="app_enable" 
                        data-toggle="custom_form_contact_email_instructions" name="mo_customer_validation_custom_form_enable_type" 
                        value="'.$custom_form_type_email.'"
                        '.( $custom_form_enabled_type == $custom_form_type_email ? "checked" : "").' /><strong>
                        '. mo_( "Enable Email verification").'</strong>
                    </p>
                    <div '.($custom_form_enabled_type != $custom_form_type_email ? "hidden" :"").' class="mo_registration_help_desc" 
