...
echo'
			<div class="mo_registration_table_layout mo-otp-center">
				<div style="width:100% ">
					<h3>
								...
								<span style="float:right;margin-top:-10px;">
									<input type="submit" '.$disabled.' name="save" id="cf_settings_button" 
				...
				<b>'. mo_("Choose between Phone or Email Verification").' <br><br> </b>
						        ...
						        name="cf_enable_type" 
						        value="'.$custom_form_type_phone.'" checked/>
                        ...
                        <input  type="radio" 
							    ...
							    '.( $custom_form_otp_type == $custom_form_type_email ? "checked" : "").' />
          ...
          <br/><input type="text" name="cf_submit_id" style="width:100%;padding:0.5%;" placeholder = "Enter your form\'s Submit button selector" value="'.mo_($custom_form_submit_selector).'"/>
          </p>
       <p>   		
...
echo '<p >
                    ...
                    <input style="width:100%;padding:0.5%;" name="cf_button_text" type="text" value="'.$button_text.'">                 
                </p>
